...
See [PHASES.md](./PHASES.md). D0 journeys J0–J3 are `build-ready` (2026-08-30). Architecture is **locked** in [DECISIONS.md](./DECISIONS.md). Demo slice lives in `client/`, `server/`, `shared/`.
